...
const Feedback = () => {
  return (
    <div className="w-full h-screem bg-deep_blue flex flex-col justify-center items-center pt-10 pb-10">
      <div className="w-3/5 h-auto flex justify-center items-center flex-col bg-gray-950 curve_left border-white border-2 rounded-tr-xl rounded-bl-xl  ">
        <p className="text-full text-3xl text-white my-5 ">Contact Details</p>
        <div className="flex justify-center items-center text-center flex-col">
          <span className="rounded-3xl bg-purple h-14 w-14 flex justify-center items-center">
            <Location />
          </span>
