...
const FeedbackTwo = () => {
  return (
    <div className="w-full h-auto bg-deep_blue flex flex-col justify-center items-center pb-10 ">
      <div className="w-3/5 h-auto flex justify-center items-center flex-col bg-gray-950 curve border-white border-2 rounded-tr-xl rounded-bl-xl  ">
        <p className="text-full text-3xl text-white my-3 ">SUBSCRIBE</p>
        <div className="flex w-8/12 justify-center items-center text-center flex-row bg-white h-12 rounded-md px-1">
        ...
        <span className="h-5"></span>
        <div className="flex overflow-hidden py-2  w-8/12 justify-center items-center text-center flex-row bg-white h-auto rounded-md px-1">
          <textarea
            row={20}
            col={10}
